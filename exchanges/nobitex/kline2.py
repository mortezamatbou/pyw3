...
_from_ = 1709757000  # 2024-03-07 00:00:00 1402-12-17
_from_ = 1717792200  # 2024-03-07 00:00:00 1402-12-17
symbol = 'BTCIRT'
...
while True:
    for start in intraday:
        ...
        for index, row in df.iterrows():
            ...
            values = (
            pair_id, ex_id, row['t'], (row['t'] + (resolution * 60)), row['o'], row['h'], row['l'], row['c'], row['v'],
            row['numOfTrade'])
