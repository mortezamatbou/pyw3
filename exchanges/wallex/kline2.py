...
# BTCTMN
_from_ = 1641699000  # 2022-01-09 07:00:00
_from_ = 1685478600  # 2022-01-09 07:00:00
symbol = 'BTCTMN'
...
while True:
    for start in intraday:
        ...
        for index, row in df.iterrows():
            ...
            values = (pair_id, ex_id, row['t'], (row['t'] + (resolution * 60)), row['o'], row['h'], row['l'], row['c'], row['v'], row['numOfTrade'])
